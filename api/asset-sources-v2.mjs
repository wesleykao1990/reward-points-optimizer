import { createAssetSourceCatalogueV2Reader } from "../apps/consumer-alpha/dist/asset-source-catalogue-v2.js";
...
function catalogueReader() {
  ...
  reader = createAssetSourceCatalogueV2Reader(
    connectionString,
...
export default async function handler(request, response) {
  ...
  try {
    ...
    sendJson(response, 503, {
      error: {
        code: "asset_sources_unavailable",
        message: "Request could not be processed.",
      },
    });
  }
