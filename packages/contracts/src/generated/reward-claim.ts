...
export type Claim = {
  ...
  calculation?: PercentageCalculation | PointsPerUnitCalculation | FixedCalculation | TransferCalculation;
  output?: Output;
  caps?: Cap[];
  expiry?: Expiry;
  validity?: Validity;
...
/**
 * An exact, transport-independent structured claim projection. It is not a RewardRule and contains no trust or publication assertions.
 */
export interface StructuredRewardClaimDocument {
